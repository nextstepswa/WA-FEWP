...
pop2024 <- read_csv("ftp://ftp2.census.gov/programs-surveys/popest/datasets/2020-2024/state/totals/NST-EST2024-ALLDATA.csv") %>%
  filter(SUMLEV %in% c("010", "040")) %>%
  select(NAME, contains("POPESTIMATE"))

pop <- left_join(pop2020, pop2024, by = "NAME") %>%
  rowwise() %>%
  mutate(POPESTIMATE2020 = mean(c_across(contains("2020")))) %>%
  select(NAME, POPESTIMATE2015:POPESTIMATE2019, POPESTIMATE2020, POPESTIMATE2021:POPESTIMATE2024) %>%
